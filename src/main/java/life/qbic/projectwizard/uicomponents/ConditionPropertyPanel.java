...
public class ConditionPropertyPanel extends VerticalLayout {
  ...
  private static final Logger logger = LogManager.getLogger(ConditionPropertyPanel.class);
   ...
   */
  public ConditionPropertyPanel(String condition, EnumSet<life.qbic.xml.properties.Unit> units) {
